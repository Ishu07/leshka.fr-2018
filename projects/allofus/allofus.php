  ...
  <div class="wrapper article">
    <div class="big-right">
      ...
      projects/allofus/img/templates/17.jpg' >
        ...
        <img class="full" src="projects/allofus/img/templates/04.jpg" />
        <img class="full" src="projects/allofus/img/templates/05.jpg" />
        <img class="full" src="projects/allofus/img/templates/07.jpg" />
        <img class="full" src="projects/allofus/img/templates/08.jpg" />
        <img class="full" src="projects/allofus/img/templates/09.jpg" />
        <img class="full" src="projects/allofus/img/templates/10.jpg" />
        <img class="full" src="projects/allofus/img/templates/11.jpg" />
        <img class="full" src="projects/allofus/img/templates/12.jpg" />
        <img class="full" src="projects/allofus/img/templates/13.jpg" />
...
<a href="http://allofus.com/" target="_blank" class="button">allofus.com <span class="arrow">➩</span></a></p>
    ...
    <div class="separator"></div>
      ...
      projects/allofus/img/creds/32.jpg' >
        ...
        <img class="full" src="projects/allofus/img/creds/05.jpg" />
        <img class="full" src="projects/allofus/img/creds/07.jpg" />
        <img class="full" src="projects/allofus/img/creds/08.jpg" />
        <img class="full" src="projects/allofus/img/creds/09.jpg" />
        <img class="full" src="projects/allofus/img/creds/10.jpg" />
        <img class="full" src="projects/allofus/img/creds/11.jpg" />
        <img class="full" src="projects/allofus/img/creds/12.jpg" />
        <img class="full" src="projects/allofus/img/creds/13.jpg" />
        <img class="full" src="projects/allofus/img/creds/14.jpg" />
        <img class="full" src="projects/allofus/img/creds/15.jpg" />
        <img class="full" src="projects/allofus/img/creds/16.jpg" />
        <img class="full" src="projects/allofus/img/creds/17.jpg" />
        <img class="full" src="projects/allofus/img/creds/18.jpg" />
        <img class="full" src="projects/allofus/img/creds/19.jpg" />
        <img class="full" src="projects/allofus/img/creds/20.jpg" />
        <img class="full" src="projects/allofus/img/creds/21.jpg" />
        <img class="full" src="projects/allofus/img/creds/22.jpg" />
        <img class="full" src="projects/allofus/img/creds/23.jpg" />
        <img class="full" src="projects/allofus/img/creds/24.jpg" />
        <img class="full" src="projects/allofus/img/creds/25.jpg" />
        <img class="full" src="projects/allofus/img/creds/26.jpg" />
        <img class="full" src="projects/allofus/img/creds/27.jpg" />
        <img class="full" src="projects/allofus/img/creds/28.jpg" />
